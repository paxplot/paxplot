...
class TestCategoricalTicks:
    ...
    def test_generate_ticks_from_categories_with_duplicates(self):
        ...
        with pytest.raises(ValueError, match="Duplicate category 'Blue' found at index 2"):
            ticks.set_ticks_from_categories(categories)

    def test_generate_ticks_from_categories_preserves_exact_input(self):
        """Test that categories are used exactly as supplied."""
    ...
    def test_generate_ticks_from_categories_empty_input(self):
        ...
        with pytest.raises(ValueError, match="Categories cannot be empty"):
            ticks.set_ticks_from_categories([])
